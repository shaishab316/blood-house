...
async function main(): Promise<void> {
  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      choices: [
        { name: 'Route', value: 'route', checked: false },
        ...
        { name: 'Controller', value: 'controller', checked: false },
        { name: 'Service', value: 'service', checked: false },
        { name: 'Validation', value: 'validation', checked: false },
